...
MODEL_FILENAME = "bpsr_splash.onnx"
    ...
    f"https://github.com/{GITHUB_REPO}/releases/latest/download/{MODEL_FILENAME}"
)
...
def ensure_model(weights_path: str) -> None:
    """
    Make sure *weights_path* exists.  If it does not, download it from the
    latest GitHub release.  Raises RuntimeError on failure.
    """
